		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "moviecard01",
									"targetURL": "#comibmmoviecard01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibmmoviecard01-display": {
								"semanticObject": "comibmmoviecard01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibm.moviecard01",
									"url": sap.ui.require.toUrl("com/ibm/moviecard01")
								}
							}
						}
					}
